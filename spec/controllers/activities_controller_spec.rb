  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved activity as @activity" do
        ...
        post :create, {:activity => { "project" => "invalid value" }}, valid_session
        assigns(:activity).should be_a_new(Activity)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested activity" do
        ...
        Activity.any_instance.should_receive(:update).with({ "project" => "" })
        put :update, {:id => activity.to_param, :activity => { "project" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the activity as @activity" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Activity.any_instance.stub(:save).and_return(false)
        put :update, {:id => activity.to_param, :activity => { "project" => "invalid value" }}, valid_session
        assigns(:activity).should eq(activity)
      end
